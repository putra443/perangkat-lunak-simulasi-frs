        ...
        <div className='w-3/5 p-5'>
          ...
          <form action="" method="get" className='mt-8 space-y-6' onSubmit={(e) => handleLogin(e)}>
            <div className='flex flex-col items-center'>
              ...
              {/* <input type='submit' value='Sign In' className='btn bg-sky-500 hover:bg-sky-600 text-white border-none rounded-2xl px-5 py-2'></input>
              <input type='submit' value='Sign In as Admin' className='btn bg-sky-500 hover:bg-sky-600 text-white border-none rounded-2xl px-5 py-2 mt-5'></input> */}
              {/* <a  href='http://localhost:3000/home' className='btn bg-sky-500 hover:bg-sky-600 text-white border-none rounded-2xl px-5 py-2'>Sign In</a>
              <a  href='http://localhost:3000/homeAdmin' className='btn bg-sky-500 hover:bg-sky-600 text-white border-none rounded-2xl px-5 py-2 mt-5'>Sign in as Admin</a> */}
              <button type='submit' className='btn bg-sky-500 hover:bg-sky-600 text-white border-none rounded-2xl px-5 py-2'>Sign In</button>
            </div>
          </form>
        </div> {/*sign in */}
